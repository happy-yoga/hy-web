...
export class Teaser extends ContentType {
  ...
  update ({ sys: { updatedAt }, fields: { backgroundImage, title, link, showLinkAsActionButton, headline, text } }) {
    Object.assign(this, { updatedAt: new Date(updatedAt), title: title?.de, showLinkAsActionButton: showLinkAsActionButton?.de, headline: headline?.de, text: text?.de })
