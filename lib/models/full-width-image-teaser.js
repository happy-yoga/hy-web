...
export class FullWidthImageTeaser extends ContentType {
  ...
  update ({ sys: { updatedAt }, fields: { title, headline, link, backgroundImage, teaserText } }) {
    Object.assign(this, { updatedAt: new Date(updatedAt), title: title?.de, headline: headline?.de, teaserText: teaserText?.de })
    this._link = link?.de
